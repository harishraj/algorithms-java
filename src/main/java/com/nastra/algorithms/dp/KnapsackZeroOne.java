 ...
 * 
 * @see http
 *      ://www.geeksforgeeks.org/dynamic-programming-set-10-0-1-knapsack-problem
 *      /
...
public class KnapsackZeroOne {
	 ...
	 * @return The max value subset of val[] such that sum of the weights of
	...
	public static void main(String[] args) {
		...
		int wt[] = { 10, 20, 30 };
		int W = 50;
		System.out.println("Max value using naive approach: "
				+ knapsack(val, wt, W));
		System.out.println("Max value using DP approach: "
				+ knapsackDP(val, wt, W));
		...
		System.out.println("Max value using naive approach: "
				+ knapsack(val3, wt3, W));
		System.out.println("Max value using DP approach: "
				+ knapsackDP(val3, wt3, W));
	}

	/**
	 * Time complexity is O(n * W) where n is the number of values and W is the
